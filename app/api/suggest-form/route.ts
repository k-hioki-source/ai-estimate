...
manual = 取扱説明書・各種マニュアル
例：取扱説明書、作業手順、安全手順、組立説明、サービスマニュアル、施工手順、操作説明

parts = パーツカタログ・分解図
例：パーツカタログ、部品カタログ、パーツリスト、部品リスト、部品表、分解図、構成図、部品構成図

sales = 販促用・ウェブサイト・製品説明図
例：販促資料、製品説明、製品説明図、構造説明図、概念図、イメージ図、プレゼン資料、WEB掲載、ホームページ、展示会、広告、パンフレット、安全教育、ヒヤリハット、危険予知、労災防止

【重要】

製品の構造・仕組み・特長を説明するイラストは、
取扱説明書用でない限り sales を優先する。

「製品説明図」「構造説明図」「概念図」「イメージ図」「プレゼン」「WEB」「ホームページ」「展示会」「販促」が含まれる場合は sales を優先する。

「パーツカタログ」「部品表」「パーツリスト」「分解図」が含まれる場合は parts を優先する。

「取扱説明書」「作業手順」「組立説明」「サービスマニュアル」が含まれる場合は manual を優先する。
...
以下の場合は realistic_illustration を優先する。
...
複数素材の質感を描き分ける場合は
technical_drawingではなく
realistic_illustrationとする。
